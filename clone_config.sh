...
read -p "Enter GCM (e.g., IPSL-CM6A-LR): " gcm
read -p "Enter RCM: " rcm
...
source_folder="ANT50.GL1-PMIP.REF"
target_folder="ANT50.GL1-${ssp}_${gcm}_${rcm}_EXP${exp}"
...
sed -i "s/<RCM>/$rcm/g" "$target_folder/config_case.txt"
